...
> **Note**: The **Merge** button is only active when two or more datasets are selected via the checkbox of the *Datasets* widget.
{style='note'}

![Figure: Merge Datasets](Merge Datasets.png)
...
> **Important**: Settings for merging and adjusting individual datasets cannot be changed anymore, once the merged dataset has been created. Please ensure all adjustments and settings have been chosen correctly before clicking OK.
{style='warning'}
