...
A workspace which has been saved previously can be opened via **File** – **Open Workspace** or **File** – **Open recent** or by clicking the **Open Workspace** button. Workspaces which have been used recently in TSE Analytics can be easily accessed via **File** – **Open Recent**.
...
Please ensure to either export graphs and analysis result or to add the respective graphs and tables to the report followed by either saving/ printing or saving the workspace.
