...
![Export Data from PM Software.png](Export Data from PM Software.png)

Next, select the required data types for export:

![Figure: Select Data](Selcetn Data.png)
...
![Figure: Save the exported file](Save the exported file.png)
...
![Figure: TSE Analytics Export](TSE Analytics Export.png)

Upon successful completion, a confirmation message will be displayed:

![Figure: Export successful](Export successful.png)
...
![Figure: Importing](Importing.png)
...
![Active Dataset](Active Dataset.png)
...
![Figure :Select the Main Dataset](Select the Main Dataset.png)
...
![Figure: Display the Dataset](Display the Dataset.png)
...
![Figure: Table Display](Table.png)

![Figure: Plot Display](image_3.png)
...
![Selected Dataset.png](Selected Dataset.png)
