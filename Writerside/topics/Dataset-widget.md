...
*Figure: Adjust button in the header of the dataset widget*

![image_14.png](image_14.png)

*Figure: Adjust dataset window*
...
*Figure: Example for trimming before (left) abd after (right) the exclusion of a time phase at the beginning of the experiment.*
...
*Figure: Exclude animals (animals to be excluded highlighted in blue*
