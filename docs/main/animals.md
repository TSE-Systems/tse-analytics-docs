...
allows filtering (exclude) some of them from further analysis and visualisation.

![Figure: Animals](../images/animals.png)
...
![Figure: Editing animals ID](../images/Editing animals ID.png)
...
![Selecting animals.png](../images/Selecting animals.png)

!!! note
    When there is no selection in the animals list, it is considered as if all animals are selected!
