...
![Figure: Binning Plot Example ](../images/Binning Plot Example.png)
...
![Figure: Binning widget](../images/binning-widget.png)
...
![Figure: Time Intervals binning mode](../images/time-intervals-binning-mode.png)
...
![Figure: Cycles binning mode](../images/cycles-binning-mode.png)
...
![Figure: Time Phases binning mode](../images/time-phases-binning-mode.png)

!!! warning
    Changes in time binning settings are not applied automatically to the data table in the _Table_ widget and plots in the _Plot_ widget.
