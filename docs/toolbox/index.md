...
> **Note**: <br/> To display plots or apply any changes in the plot settings, for example, when changing variables or groups — DO NOT forget to click **Update** in the control panel. The graphs will not update automatically.
<br/> However, any changes in the graph appearance made through the **Plot Menu** are applied immediately, WITHOUT the need to click **Update**.
{style = 'note'}
