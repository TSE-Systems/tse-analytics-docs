...
![Figure: Matrix plot widgets](../../images/Matrix plot widgets.png)
...
![Figure: Matrix Plot widget](../../images/matrix-plot-widget.png)
...
!!! note
    The Matrix Plot works by identifying the pairwise relationships between selected features. Therefore, the software only works at least **two or more variables** for the Matrix Plot to generate meaningful results.
