...
![Plot widget.png](../../images/Plot widget.png)
...
!!! warning
    Only animals selected in the Animal list are considered for the calculation of plots in the Plot widget

![Figure: Selecting widgets](../../images/Selecting widgets.png)
...
![Figure: Plot displays errors](../../images/Plot displays errors.png)
...
![Figure: Scatter Plot and Line Plot](../../images/Scatter Plot and Line Plot.png)
...
![Figure: Plot options](../../images/plot-data-view-options.png)

!!! note
    All changes made through the control panel are reflected automatically in the plot. For large datasets, there may be a short delay of a few seconds.
