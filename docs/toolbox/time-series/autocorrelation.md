...
![Figure: Time Series Autocorrelation command](../../images/timeseries-autocorrelation-command.png)


![Timeseries autocorrelation widget](../../images/timeseries-autocorrelation-widget.png)

!!! note
    The y-axis shows the correlation values, ranging from -1 to +1, representing the strength and direction of the relationship between the data points.
