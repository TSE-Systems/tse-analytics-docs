...
![Figure: Time Series Decomposition command](../../images/time-series-decomposition-command.png)
...
![Figure: Timeseries decomposition widget](../../images/timeseries-decomposition-widget.png)
