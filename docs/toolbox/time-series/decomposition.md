...
![Figure: Time Series Decomposition command](time-series-decomposition-command.png)
...
![Figure: Timeseries decomposition widget](timeseries-decomposition-widget.png)
